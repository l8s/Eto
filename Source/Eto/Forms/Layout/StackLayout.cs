...
namespace Eto.Forms
{
	...
	public class StackLayout : Panel
	{
        ...
        protected override void CloneProperties(Widget widgetToClone)
        {
            ...
            StackLayout layout = (StackLayout)widgetToClone;

            SuspendLayout();

            AlignLabels = layout.AlignLabels;
            Orientation = layout.Orientation;
            Spacing = layout.Spacing;
            HorizontalContentAlignment = layout.HorizontalContentAlignment;
            VerticalContentAlignment = layout.VerticalContentAlignment;

            foreach (StackLayoutItem itemToClone in layout.Items)
            {
                StackLayoutItem item = new StackLayoutItem((Control) itemToClone.Control.Clone());
                item.HorizontalAlignment = itemToClone.HorizontalAlignment;
                item.VerticalAlignment = itemToClone.VerticalAlignment;
                item.Expand = itemToClone.Expand;
                items.Add(item);
            }
